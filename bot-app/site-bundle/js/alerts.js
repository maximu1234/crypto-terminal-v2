...
import("./alerts-cloud-sync.js?v=52")
.then(m=>fn(m))
.catch(err=>{
...
await import("./cloud-sync.js?v=52");
...
void import("./alerts-cloud-sync.js?v=52").then(async m=>{
...
void import("./alerts-cloud-sync.js?v=52").then(m=>{
