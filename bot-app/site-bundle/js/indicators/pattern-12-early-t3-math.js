/**
 * Терминал: порт Pine «1-2 EARLY T3» (точка 3 с RSI 5 / 52-48).
 * Не бот и не оригинал js/indicators/pattern-12.js / pattern-12-math.js / pattern-12-paint.js.
 * Образец: js/algo-trading/pine/1-2-EARLY_T3_RSI5_52-48_PLUS1.pine
 */
import {
calculateRSI
...
export const PATTERN_12_EARLY_T3_ID =
"pattern-12-early-t3";
...
lngRsiOverbought:
clampInt(
raw?.lngRsiOverbought ??
raw?.rsiOverbought,
1,
99,
base.lngRsiOverbought
),
lngRsiOversold:
clampInt(
raw?.lngRsiOversold ??
...
lngMicRsiOverbought:
clampInt(
raw?.lngMicRsiOverbought ??
raw?.rsiOverbought,
1,
99,
base.lngMicRsiOverbought
),
lngMicRsiOversold:
clampInt(
raw?.lngMicRsiOversold ??
raw?.rsiOversold,
0,
99,
base.lngMicRsiOversold
),
shtRsiOverbought:
clampInt(
raw?.shtRsiOverbought ??
raw?.rsiOverbought,
1,
99,
base.shtRsiOverbought
),
shtRsiOversold:
clampInt(
raw?.shtRsiOversold ??
...
shtMicRsiOverbought:
clampInt(
raw?.shtMicRsiOverbought ??
raw?.rsiOverbought,
1,
99,
base.shtMicRsiOverbought
),
shtMicRsiOversold:
clampInt(
raw?.shtMicRsiOversold ??
raw?.rsiOversold,
0,
99,
base.shtMicRsiOversold
),
earlyT3RsiLen:
clampInt(
raw?.earlyT3RsiLen,
...
export function scanCompletePatternsForTest(
side,
candles,
senLog,
micLog,
