/** Algo isolated copy of bybit/chart-overlay.js — uses algoTrading IPC. */
/**
...
window.addEventListener(
"algo-total-pnl-visibility-changed",
()=>{
invalidateBadgeLayoutCache();
scheduleDraw(
true
