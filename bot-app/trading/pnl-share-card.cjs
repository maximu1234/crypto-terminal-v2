...
/* electron app may be unavailable during early require */
}

/* bot-app/trading → bot-app root (not monorepo root) */
return path.resolve(
__dirname,
".."
);
