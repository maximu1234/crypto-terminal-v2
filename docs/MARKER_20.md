...
**Предыдущий эталон отката.** Текущая: [MARKER_21.md](./MARKER_21.md) (`metka-21`).
...
| Тег | Роль |
|-----|------|
| `metka-21` | **Текущий** эталон — см. [MARKER_21.md](./MARKER_21.md) |
| `metka-20` | Эталон перед экспериментами с RSI на Главной/Терминале |
| `metka-19` | Архив |
...
git checkout metka-20   # этот документ (metka-20)
git checkout metka-19   # до разделения фона / RSI DOM / terminal alerts
```

## Следующий шаг

- Завершено: RSI на **Главной** и **Терминале**, ellipsis в таблице Монет
