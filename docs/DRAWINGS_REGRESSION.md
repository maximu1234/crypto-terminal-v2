...
**База отката:** `git checkout metka-7`
...
| Фаза | Содержание | Метка (план) |
|------|------------|--------------|
| 0 | этот чеклист + autotests | `metka-7` (база) |
| 1 | wire `draw-hit` + `draw-render` | `metka-8` |
| 2 | wire `drawings-tablet-input` | `metka-9` |
| 3 | `drawings-cloud` split | TBD |
