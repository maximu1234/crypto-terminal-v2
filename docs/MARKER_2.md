# Метка 2 — алерты (эталон по алертам)
...
- [**Метка 3**](MARKER_3.md) — iPad-график `/coins`, шкала как на десктопе, тег `metka-3`.
- [**Метка 1**](MARKER_1.md) (старая) — алерты до cross-TF, коммит `cd152b6` / база `a8d79cf`.
