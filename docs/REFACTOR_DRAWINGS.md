...
**Текущий эталон:** [MARKER_10.md](./MARKER_10.md) (`metka-10`, desktop; iPad pending).
...
| **3** | Split `drawings-cloud-sync.js` | высокий | ✅ `metka-10` (desktop; iPad перед push) |
| **4** | Split `alerts-cloud-sync.js` | высокий | pending (модули в `alerts-cloud/` — синтаксис сломан, не подключать) |
