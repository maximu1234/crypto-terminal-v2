...
} from "./alerts-cloud-sync.js?v=98";
...
import("./alerts-cloud-sync.js?v=98")
.then(m=>fn(m))
.catch(err=>{
...
await import("./alerts-cloud-sync.js?v=98");
...
void import("./alerts-cloud-sync.js?v=98").then(async m=>{
...
void import("./alerts-cloud-sync.js?v=98").then(m=>{
