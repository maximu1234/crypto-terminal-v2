...
} from "./alerts-cloud-sync.js?v=84";
...
import("./alerts-cloud-sync.js?v=84")
.then(m=>fn(m))
.catch(err=>{
...
await import("./alerts-cloud-sync.js?v=84");
...
void import("./alerts-cloud-sync.js?v=84").then(async m=>{
...
void import("./alerts-cloud-sync.js?v=84").then(m=>{
