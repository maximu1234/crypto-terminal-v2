...
import("./alerts-cloud-sync.js?v=107")
.then(m=>fn(m))
.catch(err=>{
...
void import("./alerts-cloud-sync.js?v=107").then(async m=>{
...
void import("./alerts-cloud-sync.js?v=107").then(m=>{
...
const drawingsCloud =
await import("./drawings-cloud-sync.js?v=38");
