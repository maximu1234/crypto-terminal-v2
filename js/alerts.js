...
import("./alerts-cloud-sync.js?v=106")
.then(m=>fn(m))
.catch(err=>{
...
await import("./alerts-cloud-sync.js?v=106");
...
void import("./alerts-cloud-sync.js?v=106").then(async m=>{
...
void import("./alerts-cloud-sync.js?v=106").then(m=>{
