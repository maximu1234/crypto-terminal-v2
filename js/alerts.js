...
import("./alerts-cloud-sync.js?v=81")
.then(m=>fn(m))
.catch(err=>{
...
await import("./alerts-cloud-sync.js?v=81");
...
void import("./alerts-cloud-sync.js?v=81").then(async m=>{
...
void import("./alerts-cloud-sync.js?v=81").then(m=>{
