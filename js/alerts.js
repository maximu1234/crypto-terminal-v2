...
import("./alerts-cloud-sync.js?v=97")
.then(m=>fn(m))
.catch(err=>{
...
await import("./alerts-cloud-sync.js?v=97");
...
void import("./alerts-cloud-sync.js?v=97").then(async m=>{
...
void import("./alerts-cloud-sync.js?v=97").then(m=>{
