...
} from "./alerts-cloud-sync.js?v=96";
...
import("./alerts-cloud-sync.js?v=96")
.then(m=>fn(m))
.catch(err=>{
...
await import("./alerts-cloud-sync.js?v=96");
...
void import("./alerts-cloud-sync.js?v=96").then(async m=>{
...
void import("./alerts-cloud-sync.js?v=96").then(m=>{
