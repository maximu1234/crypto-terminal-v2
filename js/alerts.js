...
} from "./alerts-cloud-sync.js?v=87";
...
import("./alerts-cloud-sync.js?v=87")
.then(m=>fn(m))
.catch(err=>{
...
await import("./alerts-cloud-sync.js?v=87");
...
void import("./alerts-cloud-sync.js?v=87").then(async m=>{
...
void import("./alerts-cloud-sync.js?v=87").then(m=>{
