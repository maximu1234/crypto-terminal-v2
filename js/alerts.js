...
import("./alerts-cloud-sync.js?v=82")
.then(m=>fn(m))
.catch(err=>{
...
await import("./alerts-cloud-sync.js?v=82");
...
void import("./alerts-cloud-sync.js?v=82").then(async m=>{
...
void import("./alerts-cloud-sync.js?v=82").then(m=>{
