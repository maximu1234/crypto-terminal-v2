...
import("./alerts-cloud-sync.js?v=110")
.then(m=>fn(m))
.catch(err=>{
...
void import("./alerts-cloud-sync.js?v=110").then(async m=>{
...
void import("./alert-monitor.js?v=65").then(m=>{
