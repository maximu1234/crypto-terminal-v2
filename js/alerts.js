...
} from "./alerts-cloud-sync.js?v=86";
...
import("./alerts-cloud-sync.js?v=86")
.then(m=>fn(m))
.catch(err=>{
...
await import("./alerts-cloud-sync.js?v=86");
...
void import("./alerts-cloud-sync.js?v=86").then(async m=>{
...
void import("./alerts-cloud-sync.js?v=86").then(m=>{
