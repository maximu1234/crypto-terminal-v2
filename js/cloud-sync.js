...
void import("./drawings-cloud-sync.js?v=14").then(
m=>{
...
return import("./drawings-cloud-sync.js?v=14").then(
m=>
...
const drawingsCloud =
await import("./drawings-cloud-sync.js?v=14");
...
await import("./drawings-cloud-sync.js?v=14").then(
m=>
m.pullDrawingsFromCloud()
);
