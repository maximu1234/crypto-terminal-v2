...
void import("./drawings-cloud-sync.js?v=11").then(
m=>{
...
return import("./drawings-cloud-sync.js?v=11").then(
m=>
...
const drawingsCloud =
await import("./drawings-cloud-sync.js?v=11");
...
await import("./drawings-cloud-sync.js?v=11").then(
m=>
m.pullDrawingsFromCloud()
);
