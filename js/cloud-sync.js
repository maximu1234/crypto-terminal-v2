...
void import("./drawings-cloud-sync.js?v=15").then(
m=>{
...
return import("./drawings-cloud-sync.js?v=15").then(
m=>
...
const drawingsCloud =
await import("./drawings-cloud-sync.js?v=15");
...
await import("./drawings-cloud-sync.js?v=15").then(
m=>
m.pullDrawingsFromCloud()
);
