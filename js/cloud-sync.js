...
void import("./drawings-cloud-sync.js?v=4").then(
m=>{
...
return import("./drawings-cloud-sync.js?v=4").then(
m=>
...
const drawingsCloud =
await import("./drawings-cloud-sync.js?v=4");
...
await import("./drawings-cloud-sync.js?v=4").then(
m=>
m.pullDrawingsFromCloud()
);
