...
void import("./drawings-cloud-sync.js?v=16").then(
m=>{
...
return import("./drawings-cloud-sync.js?v=16").then(
m=>
...
const drawingsCloud =
await import("./drawings-cloud-sync.js?v=16");
...
await import("./drawings-cloud-sync.js?v=16").then(
m=>
m.pullDrawingsFromCloud()
);
