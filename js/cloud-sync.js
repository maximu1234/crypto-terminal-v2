...
void import("./drawings-cloud-sync.js?v=21").then(
m=>{
...
return import("./drawings-cloud-sync.js?v=21").then(
m=>
...
const drawingsCloud =
await import("./drawings-cloud-sync.js?v=21");
...
await import("./drawings-cloud-sync.js?v=21").then(
m=>
m.pullDrawingsFromCloud()
);
