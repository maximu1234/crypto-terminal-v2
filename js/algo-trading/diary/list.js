...
/** Separate day-cache namespace (not Terminal bybit). */
const EXCHANGE_ID = "algo_bybit";
...
export async function diaryAfterListPaint(_ctx) {
  /* Fast list like Terminal diary: skipExecutions on load; detail on row expand. */
}
