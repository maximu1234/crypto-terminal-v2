/**
 * Индикатор АлгоТрейдинг: «Паттерн 1-2, 1-2 — EARLY T3».
 * Образец Pine не меняем: js/algo-trading/pine/1-2-EARLY_T3_RSI5_52-48_PLUS1.pine
 * Оригинал js/indicators/pattern-12* и бот js/algo-trading/pattern-12* не трогаем.
 */
import {
isChartLayoutReady
...
} from "./pattern-12-early-t3-scene-cache.js?v=2";
