/**
 * BingX — пресеты объёма сделки (USDT).
 */
const DEFAULTS_KEY =
"trade_volume_defaults_bingx_v2";

const BY_SYMBOL_KEY =
"trade_volume_by_symbol_bingx_v2";

const LEGACY_KEY =
"trade_volume_presets_bingx_v1";
const TOTAL_PNL_HIDDEN_KEY =
"trade_book_total_pnl_hidden_bingx_v1";
...
<button type="button" class="trade-volume-presets-btn" id="trade-volume-presets-btn" aria-expanded="false" aria-haspopup="true" title="Пресеты объёма USDT">
<span class="trade-volume-presets-grid" aria-hidden="true"></span>
</button>
<input type="text" inputmode="decimal" class="trade-volume-presets-value" data-role="volume-label" autocomplete="off" spellcheck="false" aria-label="Активный объём USDT" title="Активный объём USDT"/>
</div>
